...
public:
    int countTrapezoids(vector<vector<int>>& points) {
        ...
        unordered_map<int,int> freq; // <y-axis,count>
        for (vector<int> v: points) freq[v[1]]++;

        // Possible ways to select n points from a pool of m is a combination:
        // m!/[n!(m-n)!], since n=2 we can reduce this to (m)(m-1)/2
        long long res = 0;
        long long sum = 0;
...
int main() {
    ...
    Solution sol;
    vvi x = {{-73,-72},{-1,-56},{-92,30},{-57,-89},{-19,-89},{-35,30},{64,-72}};
    cout << sol.countTrapezoids(x) << nl;
